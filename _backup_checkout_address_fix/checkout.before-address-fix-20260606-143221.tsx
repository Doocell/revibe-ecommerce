...
function CheckoutPage() {
  ...
  async function loadCheckout() {
    ...
    try {
      ...
      setItems(nextItems);
      setProfile((profileResult.data ?? null) as BuyerProfile | null);
    } catch (error) {
      toast.error(
  ...
  async function updateCheckoutQuantity(item: CheckoutItem, nextQuantity: number) {
            ...
            <div className="mt-8 grid gap-6 lg:grid-cols-[1fr_390px]">
              <div className="space-y-6">
                ...
                >
                  <div className="space-y-4">
                    {items.map((item) => (
                      <CheckoutProductCard
                        key={`${item.cartItemId || item.productId}-${item.productId}`}
                        item={item}
                ...
                <CheckoutSection
                  ...
                  description="Gunakan alamat profil atau isi alamat khusus checkout."
                ...
                >
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="mt-2 text-sm">
                          {shippingAddress || "Alamat belum tersedia."}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 grid gap-2">
                    ...
                    <Textarea
                      ...
                      placeholder="Kosongkan jika ingin memakai alamat dari profil."
                      rows={3}
                    />
                  </div>
                ...
                >
                  {!voucherAvailable ? (
                    <div className="rounded-xl border border-yellow-300 bg-yellow-50 p-4 text-sm text-yellow-800">
                      ...
                      satu seller. Untuk banyak seller, checkout produk per seller
                      agar kode voucher bisa digunakan.
                    </div>
                  ) : (
                    <div className="space-y-4">
              ...
              <aside className="h-fit rounded-2xl border border-border bg-card p-6">
                ...
                <div className="mt-5 space-y-3 text-sm">
                  <SummaryRow label="Jumlah Produk" value={`${items.length} item`} />
